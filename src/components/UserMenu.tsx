    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          {/* MOBILE: fixed no topo direito da tela */}
          <div className="sm:hidden fixed top-2 right-2 bg-white rounded-2xl border border-gray-100 shadow-2xl z-[70] w-[220px] overflow-hidden">
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
            >
              <Settings size={16} /> Meu Perfil
            </button>
            <button
              onClick={handleLogout}
              className="w-full flex items-center gap-2 px-3 py-3 text-sm font-medium text-red-600 hover:bg-red-50 transition-colors border-t border-gray-100"
            >
              <LogOut size={16} /> Sair da conta
            </button>
          </div>

          {/* DESKTOP: dropdown abaixo do botao */}
