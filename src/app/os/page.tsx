  ...
  async function handleAddOrder(e: React.FormEvent) {
    ...
    const { error } = await supabase
      ...
      .insert([{
        ...
        bridge_rim: formData.bridge_rim || null,
        major_angle: formData.major_angle || null,
        dp_os: formData.dp_os || null,
            ...
            <form onSubmit={handleAddOrder} className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input type="text" placeholder="ex. modelo armação" className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" value={formData.frame_width} onChange={(e) => setFormData({...formData, frame_width: e.target.value})} />
                </div>
                <div>
