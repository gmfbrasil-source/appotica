        ...
        <AccordionSection num={2} title="Receita / Grau" done={section2Done} canOpen={section1Done} isOpen={activeSection === 2} onToggle={() => setActiveSection(activeSection === 2 ? 0 : 2)} summary={section2Done ? (isSunglasses ? 'Óculos de Sol' : saleDetails.frame_width ? 'Medidas informadas' : 'Grau informado') : ''}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-3">
            <div>
              ...
              <input type="text" placeholder="ex. modelo armação" className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-950 focus:ring-2 focus:ring-blue-500 outline-none" value={saleDetails.frame_width} onChange={(e) => setSaleDetails({...saleDetails, frame_width: e.target.value})} />
            </div>
            <div>
